	...
	res := []testGremlin{
		{
			...
			label:     "laybull",
			expectAdd: "addV('laybull').property(id,'simple-id').property(single,'prop','prop-val')",
		...
		},
		{
			...
			label:     "escapee",
			expectAdd: `addV('escapee').property(id,'simple-id').property(single,'prop','prop-o\'val')`,
		...
		},
		{
			...
			label:     "no-eye-dee",
			expectAdd: "addV('no-eye-dee').property(single,'prop','prop-val')",
		...
		},
		{
			...
			expectAdd: `addV('no-eye-dee-esc').property(single,'prop','prop-o\'val')`,
		...
		},
		{
			...
			label:     "other-field",
			expectAdd: `addV('other-field').property(id,'idee-id').property(single,'prop','prop-val')`,
